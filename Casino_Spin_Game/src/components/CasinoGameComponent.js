...
import orange from "./images/1.png";
import monkey from "./images/2.png";
import banana from "./images/3.png";
import strawberry from "./images/4.png";
import "./App.scss";
class CasinoGame extends Component {
    constructor(props) {
      super(props);
      this.state = {
        wheels: [
